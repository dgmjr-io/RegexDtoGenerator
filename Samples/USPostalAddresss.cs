...
namespace Contacts
{
    public partial record class USPostalAddressBase
    {
        ...
        public static USPostalAddress Parse(string s)
        {
            ...
            {
                address2 = (string)
                    System.Convert.ChangeType(match.Groups["address2"]?.Value, typeof(string)),
                city = (string)
                    System.Convert.ChangeType(match.Groups["city"]?.Value, typeof(string)),
                state = (string)
                    System.Convert.ChangeType(match.Groups["state"]?.Value, typeof(string)),
                zipcode = (string)
                    System.Convert.ChangeType(match.Groups["zipcode"]?.Value, typeof(string)),
            };
        }
        ...
        protected USPostalAddressBase(string s)
        {
            ...
            address1 = (string)
                System.Convert.ChangeType(match.Groups["address1"]?.Value, typeof(string));
            address2 = (string)
                System.Convert.ChangeType(match.Groups["address2"]?.Value, typeof(string));
